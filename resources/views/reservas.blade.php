                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-md-8">
                        <div class="card">
                            ...
                            <form class="bg-white rounded shadow-5-strong p-5" action="{{ route('guardar_reserva') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <select class="select2 form-control" id="selectSede" name="sede" required>
